...
function draw() {
    ...
    for (var i = 0; i < n; i++) {
        for (var j = 0;j < m; j++) {
            context.drawImage(kartinka, 0, 13*16, 16, 16,
                    30*j, 30*i, 30, 30);
            if (map[i][j] == 1) {
                //context.fillStyle = "blue";
                //context.fillRect(30 * j, 30 * i, 30, 30);
                context.drawImage(kartinka, 0, 0, 16, 16,
                        30*j, 30*i, 30, 30);
            } else if (map[i][j] == 2) {
                //context.fillStyle = "#944200";
                //context.fillRect(30 * j, 30 * i, 30, 30);
                context.drawImage(kartinka, 3 * 16, 13*16, 16, 16,
                    30*j, 30*i, 30, 30);
            } else if (map[i][j] == 3) {
    ...
    //context.drawImage(kartinka, 0, 0, 16, 16, 10, 10, 30, 30);
